...
object DataBase : BaseColumns{
    ...
    const val CREATE_INCOME_TABLE = "CREATE TABLE IF NOT EXISTS $TABLE_INCOME_NAME (" +
            "${BaseColumns._ID} INTEGER PRIMARY KEY, $COLUMN_INCOME_CATEGORY_ID INTEGER, $COLUMN_INCOME_VALUE REAL, $COLUMN_INCOME_DATE_NAME TEXT)"

    const val CREATE_OUTCOME_TABLE = "CREATE TABLE IF NOT EXISTS $TABLE_OUTCOME_NAME (" +
            "${BaseColumns._ID} INTEGER PRIMARY KEY, $COLUMN_OUTCOME_CATEGORY_ID INTEGER, $COLUMN_OUTCOME_VALUE REAL, $COLUMN_OUTCOME_DATE_NAME TEXT)"
